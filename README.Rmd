...
If only using the PMCA statistical tool: `devtools::install_github("robyn-ball/PMCA")`
...
```{shell}
source ~/.virtualenvs/iggi/bin/activate
```
...
*Make sure you're in the PMCA folder!*
